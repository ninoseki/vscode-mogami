...
export class OnClearCache {
  ...
  constructor(codeLensProviders: CodeLensProvider[], hoverProviders: HoverProvider[]) {
    this.codeLensProviders = codeLensProviders
    this.hoverProviders = hoverProviders

    this.disposable = vscode.commands.registerCommand(OnClearCacheCommand, this.execute, this)
  }
