...
describe('parseProject', () => {
  it('should extract exact equal requirements with comment', () => {
    ...
    expect(result.dependencies).toEqual([
      [{ name: 'package1', specifier: '==1.0.0', type: 'ProjectName' }, [1, 0, 1, 13]],
      [{ name: 'package2', specifier: '== 2.0.0', type: 'ProjectName' }, [2, 0, 2, 15]],
      [{ name: 'package3', specifier: '==3.0.0', type: 'ProjectName' }, [3, 0, 3, 13]],
    ])
  })
